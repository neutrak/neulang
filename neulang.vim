...
" keywords
syn keyword nl_keywords exit let if else and or not xor lit sub begin recur while for after array return outs outexp inexp inchar null? pair f r list assert with
